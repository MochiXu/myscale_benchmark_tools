...
for file in walk_result_file_paths(root_path="./benchmark_results/CloudTest_v0.0.4_github_benchmark/elasticsearch_cloud_v8.12.2"):
    with open(file, 'r') as f:
        data = json.load(f)

    data['meta']['monthly_cost'] = 982.8
    data['meta']['engine']['name'] = 'elastic-v8.12.2-VectorSearch(ARM)'
